...
def get_ingame_input_artis():
    return ["BOOK_OF_BASAN", "LIGHT_OF_EGGENDIL", "TACHYON_DEFLECTOR", "SHIP_IN_A_BOTTLE", "TITANIUM_ACTUATOR",
            ...
            "PUZZLE_CUBE"],["bob","light","deflector","siab","actuator","monocle","metronome","feather","chalice",
            "compass","rainstick","beak","lens","medallion","gusset","ankh","brooch","vial","necklace","totem","cube"]
